...
export default function RootLayout({ children }) {
  return (
    ...
    props: [
      ...
      { name: 'fringe', type: 'number', def: '8', description: 'Length of the fibrous fringe along the torn edge, in px. 0 for a clean cut.' },
    ...
    controls: [
      ...
      { kind: 'range', key: 'fringe', label: 'Fringe', min: 0, max: 24, step: 1, def: 8 },
